...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Waldir", "Ozuna", "w.ozuna.gordillo@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Rocio", "Juarez", "rocio.juarez.alvarez@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("3030", "Ian Waldir", "Ozuna", "wozuna@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
