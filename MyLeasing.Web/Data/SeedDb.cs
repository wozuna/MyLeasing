...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "Rosario", "Sanchez", "961 6172300", "961 125896", "Calle Luna Calle Sol");
                AddOwner("7655544", "Jose", "Cardona", "961 9123226", "961 3223221", "Calle 77 #22 21");
                AddOwner("6565555", "Maria", "López", "961 9454332", "961 3223221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }
